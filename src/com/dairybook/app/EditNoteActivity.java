...
public class EditNoteActivity extends Activity {
	...
	private static int ID_IN_DATABASE;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Toast.makeText(EditNoteActivity.this, data,
		...
		saveButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (EDITED == true) {
					database.update("dairy", values, "id = ?",
							new String[] { String.valueOf(ID_IN_DATABASE) });
					Toast.makeText(EditNoteActivity.this, "已更新...",
							Toast.LENGTH_LONG).show();
				} else {
					database.insert("dairy", null, values);
					Toast.makeText(EditNoteActivity.this, "已保存...",
							Toast.LENGTH_LONG).show();
				}
				SAVED = true;
